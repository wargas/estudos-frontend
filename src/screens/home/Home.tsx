        ...
        <Fragment>
            ...
            <Row>
                <Col style={{ height: 300 }}>
                    <Card style={{ overflow: 'auto', height: '100%', paddingBottom: 16, scrollbarWidth: 'none' }}>
                        <RankingQuestoesDia />
        ...
        <Dropdown alignRight>
            ...
            <Dropdown.Menu>
                {disciplinas.map(disciplina =>
                    <Dropdown.Item onClick={() => setCurrent(disciplina)}
                        key={String(disciplina.id)}>{disciplina.name}</Dropdown.Item>
                )}
            </Dropdown.Menu>
        </Dropdown>
    )
